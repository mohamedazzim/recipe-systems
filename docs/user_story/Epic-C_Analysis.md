...
> **Canonical note:** canonical split representation of Epic C from `USER_STORIES.md` v1.2 — story IDs, acceptance criteria, and test cases preserved exactly; only the presentation follows the mentor's epic-file format.
