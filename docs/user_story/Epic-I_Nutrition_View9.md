...
> **Canonical note:** canonical split representation of Epic I from `USER_STORIES.md` v1.2 — story IDs, acceptance criteria, and test cases preserved exactly; only the presentation follows the mentor's epic-file format.
...
*End of Epic I — Nutrition bands. Stories I1–I7.*
